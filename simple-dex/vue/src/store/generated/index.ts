...
import SimpleDexSimpleDexSimpledexSimpledex from './simple-dex/simple-dex/simpledex.simpledex'
import SimpleDexSimpledexSimpledex from './simple-dex/simpledex.simpledex'
...
export default { 
  ...
  SimpleDexSimpleDexSimpledexSimpledex: load(SimpleDexSimpleDexSimpledexSimpledex, 'simpledex.simpledex'),
  SimpleDexSimpledexSimpledex: load(SimpleDexSimpledexSimpledex, 'simpledex.simpledex'),
